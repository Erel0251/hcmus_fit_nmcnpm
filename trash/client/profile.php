                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    ...
                    <form class="w-75">
                        ...
                        <div class="row my-2 form-outline d-flex align-items-center ">
                            ...
                            <input type="email" id="" class="col form-control" value="20120485@gmail.com" />
                        </div>
                        ...
                        <div class="row my-2 form-outline d-flex align-items-center ">
                            ...
                            <input type="date" id="" class="col form-control" value="2002-03-02" />
                        </div>
